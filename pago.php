            ...
            <div class="col-xs-12 col-sm-10 col-md-offset-3 col-md-6 col-lg-6">
                ...
                <form id="formularioPago">
                    <div class="form-group">
                        ...
                        <input pattern="[0-9]{2}/[0-9]{4}" type="text" class="form-control" required data-progression data-helper="En MasterCard y Visa son los tres ultimos digitos del area de firma de la parte posteriro de la trajeta" required placeholder="mm/aaaa">
                        <label for="">Fecha de nacimiento</label>
                        <input type="date" class="form-control" required data-progression data-helper="La ley nos exige que recopilemos esta informacion" required placeholder="dd/mm/aaaa">
                    </div>
